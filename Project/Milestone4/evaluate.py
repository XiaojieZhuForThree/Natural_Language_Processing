...
def the_correction(str):
    ...
    for i in range(len(tokens)):
        if (pos_tag([tokens[i]]))[0][1] == "NN":
            if (noun_the_dict.get(tokens[i])!= None):
...
def build_X(sentences):
    ...
    for sentence in sentences:
        ...
        correction = the_correction(sentence)
...
#X = build_X(sentences)
#Y_true = build_Y(vals)
#Y_pred = predict_Y(sentences)
#print('Precision: %f\nRecall:%f\nF-measure: %f' % evaluate_predictions(Y_pred, Y_true))
#


test = "I punched heavy on him"
print("improve1:")
print("Original sentence: " + test)
correction = verb_adv_correction(test)
print("Corrected sentence: " + correction)

test = "This is the best on globe"
print("improve2:")
print("Original sentence: " + test)
correction = the_correction(test)
print("Corrected sentence: " + correction)

test = "Rather by promoting him, they fired him."
print("improve3:")
print("Original sentence: " + test)
correction = prep_correction(test)
print("Corrected sentence: " + correction)
