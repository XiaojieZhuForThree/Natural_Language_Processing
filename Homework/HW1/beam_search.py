# -*- coding: utf-8 -*-
"""
Created on Fri Sep  6 17:01:02 2019
...
model = create_ngramlm(2, r"shakespeare.txt")
print("The five sentences generated by the beam search method on bigram: ")
for sentence in beam_search(model, 10, 5, 0.5):
    print(sentence)
    
    
# train the unmasked model and generate the sentence    
model1 = unmask_create_ngramlm(2, r"shakespeare.txt")
print("\nThe five sentences generated by the beam search method on unmasked bigram model: ")
for sentence in beam_search(model1, 10, 5, 0.5):
    print(sentence)
    
model2 = unmask_create_ngramlm(3, r"shakespeare.txt")
print("\nThe five sentences generated by the beam search method on unmasked trigram model: ")
for sentence in beam_search(model2, 10, 5, 0.5):
    print(sentence)

model3 = unmask_create_ngramlm(4, r"shakespeare.txt")
print("\nThe five sentences generated by the beam search method on unmasked 4-gram model: ")
for sentence in beam_search(model3, 10, 5, 0.5):
    print(sentence)
