# -*- coding: utf-8 -*-
"""
Created on Wed Sep  4 22:50:10 2019
...
# train the model and test the perplexity
model = create_ngramlm(3, r"shakespeare.txt")
model0 = create_ngramlm(3, r"shakespeare.txt")

model1 = create_ngramlm(3, r"shakespeare.txt")
model2 = create_ngramlm(3, r"warpeace.txt")
print("The perplexity for the Shakespeare model against sonnet with smoothing delta = 0.5: ")
print(perplexity(model, r"sonnets.txt", 0.5))
